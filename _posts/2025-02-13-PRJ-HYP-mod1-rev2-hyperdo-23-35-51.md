...
First, we will explore the different elements of the HyperDo, take them apart, then build the entire model from the ground up. 
...
<br>
 The yellow cell is a squashed dodecahedron along the 3-fold (Yellow) axis. 
...
<br>
Finish with yet another squashing of the dodecahedron along the 5-axis to create the outer shell. 
